...
# Nhận tham số từ đầu vào
SUFFIX="$1"

# Thiết lập NEXUS_HOME theo tham số
NEXUS_HOME="$HOME/.nexus_$SUFFIX"
echo "Setting NEXUS_HOME to $NEXUS_HOME"

# Kiểm tra và cài đặt Rust nếu cần
rustc --version || curl https://sh.rustup.rs -sSf | sh

# Tạo thư mục NEXUS_HOME (nếu cần)
mkdir -p "$NEXUS_HOME"

# Thêm các lệnh khác liên quan đến NEXUS_HOME ở đây
echo "NEXUS_HOME setup complete."
